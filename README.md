...
ANOVA / T-tests: To analyze differences in charges across categories such as Smoker vs Non-Smoker.


Chi-square Tests: To examine relationships between categorical variables like Region and Smoker Status.


Visualization tools like Scatter Plots, Box Plots, and Bar Charts are used to display these relationships graphically.

 Predictive Modeling
The predictive phase involves building models that can estimate medical insurance charges for new or unseen customers.
 Models such as Linear Regression or Decision Tree are used to:
Identify significant predictors of insurance charges.


Evaluate model accuracy using metrics like R² and Mean Absolute Error.


Provide insights into how lifestyle choices and demographics impact costs.
